            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
                        <div>
                            ...
                            <p className="text-sm text-slate-500 mt-1 flex items-center gap-2">
                                ...
                                <span>إجمالي العملاء المستهدفين: {totalCustomers}</span>
                            </p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex-1 overflow-y-auto p-6 custom-scroll bg-slate-50/30">
                        {totalCustomers === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-bold text-slate-700">لا يوجد عملاء في مسار هذا الفريق</h3>
                                <p className="text-slate-500 mt-2">يرجى التأكد من تعيين مسار صحيح أو إضافة عملاء للمناطق المستهدفة.</p>
                            </div>
                        ) : (
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        ...
                                        {leads.map(l => (
                                            <tr key={`lead-${l.id}`} className="hover:bg-slate-50/50 transition-colors">
                                                ...
                                                <td className="px-4 py-3 text-slate-600" dir="ltr">{l.mobile}</td>
                    ...
                    <div className="p-6 border-t border-gray-100 bg-white flex justify-end gap-3">
                        <button
                            onClick={onClose}
                            className="px-6 py-2.5 rounded-xl border border-gray-200 text-slate-600 font-bold hover:bg-gray-50 transition-colors"
                        >
                            إلغاء
                        </button>
                        <button
                            ...
                            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-8 py-2.5 rounded-xl font-bold shadow-lg shadow-emerald-500/30 transition-all"
                        >
                            <PhoneCall className="w-5 h-5" />
                            <span>توليد قائمة اتصال</span>
                        </button>
                    </div>
                </motion.div>
            </div>
